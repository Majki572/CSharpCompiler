...
// wyrażenia a ara ara
expression: expression1 ADD expression          # addIntFloat
    | expression1 SUB expression                # subIntFloat
    | expression1                               # expression1Empty
    ;
expression1: expression2 MUL expression1        # mulIntFloat
    | expression2 DIV expression1               # divIntFloat
    | expression2                               # expression2Empty
    ;
expression2: expression3 AND expression2        # andIntFloat
...
// Stringi
stringExpression: stringExpression1 ADD stringExpression   # addString
    | stringExpression1                                     # stringExpression1Empty
    ;
stringExpression1: STRING                                   # string
    | ID                                                    # idString
