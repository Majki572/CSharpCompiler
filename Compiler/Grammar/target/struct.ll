...
@str.0 = private unnamed_addr constant [7 x i8] c"ala ma\00"
...
%ala = alloca i8*
%15 = call i8* @malloc(i64 7)
store i8* %15, i8** %ala
%16 = load i8*, i8** %ala
%17 = call i8* @strcpy(i8* %16, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.0, i64 0, i64 0))
%18 = load i8*, i8** %ala
...
%trulizna = alloca i1
store i1 true, i1* %trulizna
br i1 %23, label %true1, label %false1
true1:
...
br i1 %192, label %whileTrue2, label %whileFalse2
whileTrue2:
