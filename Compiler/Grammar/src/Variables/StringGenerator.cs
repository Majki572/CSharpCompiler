...
public class StringGenerator
{
    ...
    {
        var res = "%" + Generator.Reg++ + " = call i8* @malloc(i64 " + (size + 1) + ")\n";
    ...
    {
        return "%" + Generator.Reg++ + " = call i8* @strcpy(i8* " + id + ", i8* " + value + ")\n"; 
    }
    ...
    {
        return "%" + Generator.Reg++ + " = call i8* @strcpy(i8* " + id + ", i8* getelementptr inbounds ([" + (constLength + 1) + " x i8], [" + (constLength + 1) + " x i8]* " + constId + ", i64 0, i64 0))\n";
    }
    
    public static string LoadString(string id)
    {
        return "%" + Generator.Reg++ + " = load i8*, i8** " + id + "\n";
    }
    
    public static string PrintString(string id)
    {
        return "%" + Generator.Reg++ + " = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strps, i64 0, i64 0), i8* " + id + ")\n";
    }
    
    public static string ReadString(string id)
    {
        return "%" + Generator.Reg++ + " = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @strss, i64 0, i64 0), i8* " + id + ")\n";
    }
    
    // adding string id2 to id1 / id2 may be a constant string
    public static string AddString(string id1, string id2)
    {
        return "%" + Generator.Reg++ + " = call i8* @strcat(i8* " + id1 + ", i8* " + id2 + ")\n";
    }
    ...
    {
        return "%" + Generator.Reg++ + " = call i32 @strcmp(i8* " + id1 + ", i8* " + id2 + ")\n";
    }
}